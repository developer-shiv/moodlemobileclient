...
let AddonModH5PActivityUsersAttemptsPage = class AddonModH5PActivityUsersAttemptsPage {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield _services_h5pactivity__WEBPACK_IMPORTED_MODULE_6__["AddonModH5PActivity"].logViewReport(this.h5pActivity.id, this.h5pActivity.name);
            }
            catch (error) {
    ...
    fetchUsers(refresh) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const formattedUsers = yield this.formatUsers(result.users);
            if (this.page === 0) {
    ...
    formatUsers(users) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield Promise.all(users.map((user) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                ...
                if (this.h5pActivity.grademethod === _services_h5pactivity__WEBPACK_IMPORTED_MODULE_6__["AddonModH5PActivityProvider"].GRADEMANUAL) {
                    // No score.
                }
                else if (this.h5pActivity.grademethod === _services_h5pactivity__WEBPACK_IMPORTED_MODULE_6__["AddonModH5PActivityProvider"].GRADEAVERAGEATTEMPT) {
